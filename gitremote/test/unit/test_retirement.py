...
def test_birth_year_earlier_1900():
    ...
    with pytest.raises(ValueError):
        year, month = calculate_retirement_age(birth_year)
...
def test_month_is_greater_12():
    year, month = calculate_retirement_date(1999, 6, 65, 7)
    assert year == 2065
    assert month == 1

def test_month_is_12():
    year, month = calculate_retirement_date(1999, 6, 65, 6)
    assert year == 2064
    assert month == 12

def test_month_is_less_12():
    year, month = calculate_retirement_date(1999, 6, 65, 2)
    assert year == 2064
    assert month == 8

def test_not_valid_year():
    with pytest.raises(ValueError):
        year, month = calculate_retirement_date('1999a', 6, 66, 2)

def test_not_valid_month():
    with pytest.raises(ValueError):
        year, month = calculate_retirement_date(1999, 'jan', 66, 2)

def test_not_valid_age_year():
    with pytest.raises(ValueError):
        year, month = calculate_retirement_date(1999, 6, 'b6', 2)

def test_not_valid_age_month():
    with pytest.raises(ValueError):
        year, month = calculate_retirement_date(1999, 6, 66, 'I1')


def test_valid_year():
    year, month = calculate_retirement_date('1999', 6, 66, 2)

def test_valid_month():
    year, month = calculate_retirement_date(1999, '11', 66, 2)

def test_valid_age_year():
    year, month = calculate_retirement_date(1999, 6, '66', 2)

def test_valid_age_month():
    year, month = calculate_retirement_date(1999, 6, 66, '11')
